<template>
  <main class="error text-center mt-5 py-5">
    <div class="mb-4">
      <svg
    ...
    <div>
      <h2 class="title display-5">Opss! parece que algo deu errado... :(</h2>
      <p class="mb-0">
        O recurso que você tentou acessar não existe ou está indisponível.
      </p>
      <p class="mt-0">
        <router-link to="/" class="text-light">Clique aqui</router-link> para voltar para a tela inicial.
      </p>
    </div>
  </main>
</template>
